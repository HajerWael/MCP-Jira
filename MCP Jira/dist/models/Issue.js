...
class Issue {
    static async getTypes(projectId = '') {
        try {
    ...
    static async getTasksCreatedByUserInProject(userEmail, projectKey) {
        try {
    ...
    static async createTaskInProject(projectKey, summary, taskDescription, creatorEmail) {
        try {
            const taskData = {
                fields: {
                    project: {
